...
-  [overturemaps-py](https://github.com/OvertureMaps/overturemaps-py) (last example)
...
The `from_duckdb()` function lets us query Overture data using DuckDB and then pass in the resulting table directly to Lonboard. This is extremely performant because it leverages arrow tables.
